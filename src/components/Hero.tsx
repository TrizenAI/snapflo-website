      ...
      <nav className="relative z-20 container mx-auto px-4 sm:px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <a
              href="https://demo.snapflo.studio/login"
              target="_blank"
              rel="noopener noreferrer"
              className="px-5 py-2.5 rounded-lg font-semibold text-sm lg:text-base border border-indigo-600 text-indigo-600 hover:bg-indigo-50 transition"
            >
              Sign in
            </a>
            <button
          ...
          <div className="md:hidden flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 rounded-lg font-semibold text-sm border border-indigo-600 text-indigo-600 hover:bg-indigo-50 transition"
            >
              Sign in
            </a>
            <button
